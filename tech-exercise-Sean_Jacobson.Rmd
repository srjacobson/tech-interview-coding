...
write.table(res,"C:/Users/srjac/Documents/GitHub/tech-interview-coding/output.csv", row.names = T, col.names = T, sep = ",")
...
somalogic_data_processing <- function(barcode, pred, output_directory)
{
	...
	write.table(res, paste0(output_directory, "/output.csv"), row.names = T, col.names = T, sep = ",")
